...
public class Dicionario {
	...
	@WebMethod
	@WebResult(name = "traducao")
	public String traduz(@WebParam(name = "palavra") String palavra) {
		return this.mapa.get(palavra);
	}

	@WebMethod
	public void adicionaTraducao(@WebParam(name = "palavra") String palavra,
			@WebParam(name = "traducao") String traducao) {
		this.mapa.put(palavra, traducao);
	}
